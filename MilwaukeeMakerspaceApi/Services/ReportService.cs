...
namespace Mms.Api.Services
{
	public class ReportService
	{
		...
		public void RecordStatement(UpdateStatementRequest request)
		{
			...
			if (request.Name != "PayPal" && request.Name != "Landmark Checking" && request.Name != "Landmark Savings" && request.Name != "Landmark Checking Facilities" && request.Name != "Landmark CD")
